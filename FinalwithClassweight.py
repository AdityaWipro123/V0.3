...
def train_model_classification(training_file_path):
    ...
    def preprocess_data(X, y):
        ...
        joblib.dump(scaler, os.path.join(model_folder_path, "scaler_classification11.pkl"))
    ...
    class_weight_nn = {0: 1.5, 1:100, 2: 250, 3: 80}
    ...
    model.save(os.path.join(model_folder_path, 'ensemble_modelFINP11.h5'))
...
def predict_breakdown(test_file_path):
    ...
    def preprocess_test_data(X_test):
        ...
        scaler = joblib.load(os.path.join(model_folder_path, "scaler_classification11.pkl"))
    ...
    def predict_classification(X_test_scaled):
        ...
        model = load_model(os.path.join(model_folder_path, 'ensemble_modelFINP11.h5'))
